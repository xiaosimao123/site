...
export const CodeWindow: FC<{
  ...
  return (
    <Card shadow className={router.split("/")[1] === "blog" ? "mb-8" : "mb-0"}>
      <Tabs.Root defaultValue={snippets[0].file}>
        ...
        >
          ...
          <div className="grow border-b border-gray-100 dark:border-gray-900" />
        </Tabs.List>
          ...
          {snippets.map(({ file, content, lines }, index) => (
            ...
            >
              ...
              <ScrollArea.Root className="w-full overflow-hidden bg-white dark:bg-[#0D1116]">
                <ScrollArea.Viewport>
                  <div
                    className={`text-[13] not-prose   -mt-[30px]
