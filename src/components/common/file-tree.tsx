...
export const FileTreeFolder = memo<FolderProps>(
    ...
    return (
      <li className="flex list-none flex-col">
        <button
          onClick={toggle}
          title={name}
          className="notFill inline-flex cursor-pointer items-center py-1 hover:opacity-60"
        >
          <Ident />
...
FileTreeFolder.displayName = "Folder";

export const FileTreeFile = memo<FileProps>(({ label, name, active }) => (
  <li
    className={cn(
      "flex list-none",
  ...
  >
    <span className="notFill inline-flex cursor-default items-center py-1">
      <Ident />
      <svg width="1em" height="1em" viewBox="0 0 24 24">
        <path
          fill="none"
