    ...
    <>
      <header className="relative w-full">
        <div className="mx-auto w-full max-w-3xl space-y-2 px-4 py-8 md:px-8 lg:max-w-full lg:px-16">
          ...
          <h1 className="sr-only text-2xl font-semibold text-slate-800 md:text-3xl lg:not-sr-only lg:text-4xl dark:text-slate-200">
            {title}
          </h1>
          <div className="lg:hidden">
            <button
              ...
              className="flex space-x-2 text-left text-2xl font-semibold text-slate-800 md:space-x-3 md:text-3xl lg:text-4xl dark:text-slate-200"
            >
      ...
      <div
        className={`fixed top-16 z-10 hidden h-16 w-full border-b border-gray-200 bg-white bg-opacity-90 backdrop-blur backdrop-filter transition-opacity duration-200 lg:block dark:border-gray-800 dark:bg-gray-950 ${
      ...
      >
        <ul className="flex h-full items-center space-x-2 px-16 text-sm">
          ...
          <li className="hidden text-slate-800 lg:block dark:text-slate-200">
            {title}
          </li>
        </ul>
      </div>
