...
function Pre({ children, className, ...props }: Props) {
  ...
  return (
    ...
    >
      <div className="absolute right-0 top-0 m-4 flex items-center rounded-md ">
        <span
          className={clsx("text-s hidden px-2 text-purple-400 ease-in", {
