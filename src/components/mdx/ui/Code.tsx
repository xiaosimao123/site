...
import { codeToHtml, transformerDecorations } from "shiki";
import { snippetToHtml } from "./syntax-highlighting";
// import {
...
export default async function Code({
  ...
  const html = await snippetToHtml(code, "light");
